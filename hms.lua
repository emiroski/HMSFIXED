...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       ...
       Invite = "https://discord.gg/PfaGkFXT6g", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
...
local Button = Tab:CreateButton({
   ...
   Callback = function()
      loadstring(game:HttpGet((' ')))() -- The function that takes place when the button is pressed
   end,
})
...
local Button = Tab:CreateButton({
   Name = "Celeste",
   Callback = function()
      loadstring(game:HttpGet(('https://raw.githubusercontent.com/emiroski/HMSFIXED/refs/heads/main/animstealer.lua')))() -- The function that takes place when the button is pressed
   end,
})
